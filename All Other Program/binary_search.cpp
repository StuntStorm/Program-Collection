...
static void test1() {
    // testcase #1
    // array = [1,2,3,4,9,8,6,4,1] , Value = 4
    // should return 3

    std::vector<uint64_t> arr = {{1,2,3,4,9,8,6,4,1}};
...
void test2() {
    // testcase #2
    // array = [1,22,25,5,3] , Value = 25
    // should return 4
    std::vector<uint64_t> arr = {{1,22,25,5,3}};
...
void test3() {
    // testcase #3
    // array = [1,30,300,9,9,2,5,50,21,23,12,3] , Value = 5
    // should return 8
    std::vector<uint64_t> arr = {{1, 31, 230, 11, 2, 5, 50, 20, 21, 12, 3}};
    std::sort(arr.begin(), arr.end());
